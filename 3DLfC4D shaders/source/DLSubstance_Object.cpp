...
{
	return RegisterCommandPlugin(DL_SUBSTANCE_COMMAND, "Substance Material"_s, PLUGINFLAG_HIDEPLUGINMENU, AutoBitmap("shelf_dlSubstance_200.png"_s), String("Assign new Substance"), NewObjClear(DL_Substance_command));
